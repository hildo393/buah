...
class Video_model extends CI_Model
{
  ...
  var $column = array('id_video','judul_video');
  ...
  // get all
  function get_cari_video()
  {
    $cari_blog = $this->input->post('cari_video');

    $this->db->like('judul_video', $cari_blog);
    return $this->db->get($this->table)->result();
  }
