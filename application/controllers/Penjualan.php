...
class Penjualan extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('penjualan/penjualan_list', $this->data);
  }
  ...
  public function view($id)
  {
    ...
    if($row)
    {
      ...
      $this->load->view('penjualan/penjualan_detail', $this->data);
    }
      else
      {
  ...
  public function update($id)
  {
    ...
    if($row)
    {
      ...
      $this->load->view('penjualan/penjualan_status', $this->data);
    }
      else
      {
        $this->session->set_flashdata('message', '<div class="alert alert-warning alert">Data tidak ditemukan</div>');
