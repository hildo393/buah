...
class Kontak extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $this->load->view('kontak/kontak_list', $this->data);
  }
  ...
  public function ajax_list()
    ...
    foreach ($list as $data_kontak) {
      ...
      <p style="text-align: center">
      	<a class="btn btn-sm btn-warning" href="'.base_url('kontak/update/').$data_kontak->id_kontak.'" title="Edit"><i class="fa fa-pencil"></i></a>
        <a class="btn btn-sm btn-danger" href="'.base_url('kontak/delete/').$data_kontak->id_kontak.'" title="Hapus" onclick="javasciprt: return confirm(\'Apakah Anda yakin ?\')"><i class="glyphicon glyphicon-remove"></i></a>
			</p>';
  ...
  public function create()
  {
    ...
    $this->data['action']         = site_url('kontak/create_action');
    ...
    $this->load->view('kontak/kontak_add', $this->data);
  }
  ...
  public function update($id)
  {
    ...
    if ($row)
    {
      ...
      $this->data['action']         = site_url('kontak/update_action');
      $this->data['button_submit']  = 'Simpan';
      $this->data['button_reset']   = 'Reset';
      ...
      $this->load->view('kontak/kontak_edit', $this->data);
    }
      else
      {
        $this->session->set_flashdata('message', '
