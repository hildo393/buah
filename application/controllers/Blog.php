...
class Blog extends CI_Controller
{
  ...
  public function ajax_list()
    ...
    foreach ($list as $data_blog) {
      ...
      <p style="text-align: center">
        <a class="btn btn-sm btn-warning" href="'.base_url('blog/update/').$data_blog->id_blog.'" title="Edit"><i class="fa fa-pencil"></i></a>
        <a class="btn btn-sm btn-danger" href="'.base_url('blog/delete/').$data_blog->id_blog.'" title="Hapus" onclick="javasciprt: return confirm(\'Apakah Anda yakin ?\')"><i class="fa fa-remove"></i></a>
			</p>';
  ...
  public function create()
  {
    ...
    $this->data['action']         = site_url('blog/create_action');
    ...
    $this->load->view('blog/blog_add', $this->data);
  }
  ...
  public function update($id)
  {
    ...
    if ($row)
    {
      ...
      $this->data['action']         = site_url('blog/update_action');
      $this->data['button_submit']  = 'Simpan';
      $this->data['button_reset']   = 'Reset';
      ...
      $this->load->view('blog/blog_edit', $this->data);
    }
      else
      {
        $this->session->set_flashdata('message', '
