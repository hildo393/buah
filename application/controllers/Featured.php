...
class Featured extends CI_Controller
{
  function __construct()
  {
    ...
    // elseif($this->ion_auth->is_user()){redirect('auth/login', 'refresh');}
  }
  ...
  public function index()
  {
    ...
    $this->load->view('featured/featured_list', $this->data);
  }
  ...
  public function ajax_list()
    ...
    foreach ($list as $data_featured) {
      ...
      <p style="text-align: center">
      	<a class="btn btn-sm btn-warning" href="'.base_url('featured/update/').$data_featured->id_featured.'" title="Edit"><i class="fa fa-pencil"></i></a>
        <a class="btn btn-sm btn-danger" href="'.base_url('featured/delete/').$data_featured->id_featured.'" title="Hapus" onclick="javasciprt: return confirm(\'Apakah Anda yakin ?\')"><i class="glyphicon glyphicon-remove"></i></a>
			</p>';
  ...
  public function create()
  {
    ...
    $this->data['action']         = site_url('featured/create_action');
    ...
    $this->load->view('featured/featured_add', $this->data);
  }
  ...
  public function update($id)
  {
    ...
    if ($row)
    {
      ...
      $this->data['action']         = site_url('featured/update_action');
      $this->data['button_submit']  = 'Simpan';
      $this->data['button_reset']   = 'Reset';
      ...
      $this->load->view('featured/featured_edit', $this->data);
    }
      else
      {
