...
class Slider extends CI_Controller
{
  ...
  public function ajax_list()
  {
    ...
    foreach ($list as $data_slider) {
      ...
      <p style="text-align: center">
        <a class="btn btn-sm btn-warning" href="'.base_url('slider/update/').$data_slider->id_slider.'" title="Edit"><i class="fa fa-pencil"></i></a>
        <a class="btn btn-sm btn-danger" href="'.base_url('slider/delete/').$data_slider->id_slider.'" title="Hapus" onclick="javasciprt: return confirm(\'Apakah Anda yakin ?\')"><i class="glyphicon glyphicon-remove"></i></a>
      </p>';
  ...
  public function create()
  {
    ...
    $this->data['action']         = site_url('slider/create_action');
    ...
    $this->load->view('slider/slider_add', $this->data);
  }
  ...
  public function update($id)
  {
    ...
    if ($row)
    {
      ...
      $this->data['action']         = site_url('slider/update_action');
      $this->data['button_submit']  = 'Simpan';
      $this->data['button_reset']   = 'Reset';
      ...
      $this->load->view('slider/slider_edit', $this->data);
    }
      else
      {
