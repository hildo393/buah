          ...
          <div class="col-lg-12">
              ...
              <div class="box-body">
                  ...
                  <div class="form-group"><label>Gambar Sebelumnya</label><br>
                    <img src="<?php echo base_url('assets/images/portofolio/'.$portofolio->foto.$portofolio->foto_type.'') ?>" width="200px"/>
                  </div>
                  <div class="form-group"><label>Gambar</label>
                    ...
                    <img id="preview" src="" alt="" width="350px"/>
									...
									<?php echo form_input($id_portofolio,$portofolio->id_portofolio);?>
