                  ...
                  <div class="row">
                    <input class="form-control" name="hd" type="hidden" id="c" size="30" onkeyup="hitung();" readonly/>
										<div class="col-lg-4"><label>Harga Beli</label>
											<?php echo form_input($harga_beli);?><br>
										</div>
										<div class="col-lg-4"><label>Harga Jual</label>
											<?php echo form_input($harga_jual);?><br>
										</div>
										<div class="col-lg-4"><label>Harga Reseller</label>
											<?php echo form_input($harga_reseller);?><br>
										</div>
									</div>
									<div class="row">
									...
									<div class="row">
										<div class="col-lg-6" class="form-group">
							                ...
							                <div class="input-group date">
							                  ...
							                  <input name="tgl_datang" type="date" class="form-control pull-right">
							                </div>
							              </div>
							              ...
							              <div class="col-lg-6" class="form-group">
							                ...
							                <div class="input-group date">
							                  ...
							                  <input name="kadaluarsa" type="date" class="form-control pull-right" >
							                </div>
							              </div>
										
									</div>
									<div  class="row">
										<div class="col-lg-6" class="form-group"><label>Gambar</label>
	...
	function hanyaAngka(evt) {
		  var charCode = (evt.which) ? evt.which : event.keyCode
		   if (charCode > 31 && (charCode < 48 || charCode > 57))
		    ...
		    return alert("data yang anda masukkan harus angka!");
		  return true;
		}
