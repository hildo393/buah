                          ...
                          <tr>
                            ...
                            <td style="text-align:center"><?php if(!empty($user->last_login)){echo date("Y-m-d H:i:s", $user->last_login);} ?></td>
                              ...
                              <td style="text-align:center">
                                ...
                                echo anchor(site_url('auth/delete_user/'.$user->id),'<i class="glyphicon glyphicon-remove"></i>','title="Hapus", class="btn btn-sm btn-danger", onclick="javasciprt: return confirm(\'Apakah Anda yakin ?\')"');
                                ?>
                              </td>
                            </tr>
                          <?php endforeach;?>
