<header class="main-header">
  <a href="<?php echo base_url('dashboard') ?>" class="logo">
    ...
    <span class="logo-lg"><b>Reseller Buah</b></span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-body">
              <div class="col-xs-6 text-center">
                <a href='<?php $user_id = $this->session->userdata('user_id'); echo base_url('auth/edit_user/'.$user_id.'') ?>' class='btn btn-default btn-flat'>Edit Profil</a>
              </div>
              <div class="col-xs-6 text-center">
